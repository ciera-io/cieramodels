domain ALU is
  ...
  private service testcase2 (); pragma scenario( 2 ); pragma test_only();
  private service testcase3 (); pragma scenario( 3 ); pragma test_only();
  private service testcase4 (); pragma scenario( 4 ); pragma test_only();
  private service testcase5 (); pragma scenario( 5 ); pragma test_only();
