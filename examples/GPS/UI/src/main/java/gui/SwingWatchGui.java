...
public class SwingWatchGui extends JFrame implements WatchGui, IUI {
  ...
  public static final String[] UNIT_LABELS =
      new String[] {
  ...
  public SwingWatchGui(final IUI ui) {
    ...
    lightLabel.addMouseListener(
        new ButtonListener(lightHover, powerPressed) {
          @Override
    ...
    startStopLabel.addMouseListener(
        new ButtonListener(startStopHover, startStopPressed) {
          @Override
          public void buttonPressed() {
            ui.startStopPressed();
          }
    ...
    lapResetLabel.addMouseListener(
        new ButtonListener(lapResetHover, lapResetPressed) {
          @Override
          public void buttonPressed() {
            ui.lapResetPressed();
          }
    ...
    displayLabel.addMouseListener(
        new ButtonListener(displayHover, displayPressed) {
          @Override
          public void buttonPressed() {
            ui.lightPressed();
          }
    ...
    modeLabel.addMouseListener(
        new ButtonListener(modeHover, modePressed) {
          @Override
          public void buttonPressed() {
            ui.modePressed();
          }
  ...
  /** A generic button listener that will switch images when buttons are hovered/pressed/released */
